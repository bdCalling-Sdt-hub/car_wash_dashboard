            ...
            }
            {
                UpdatePasswordFields?.map(item => {
                    ...
                    >
                        ...
                        }} />) : item?.name === 'confirmPassword' ? (confirm_password_type ? <FaEye className='text-lg hover:scale-105 active:scale-95 cursor-pointer' onClick={() => {
                            set_confirm_password_type(null)
                        }} /> : <FaEyeSlash className='text-lg hover:scale-105 active:scale-95 cursor-pointer' onClick={() => {
                            set_confirm_password_type('text')
                        }} />) : item?.name === 'oldPassword' ? (old_password_type ? <FaEye className='text-lg hover:scale-105 active:scale-95 cursor-pointer' onClick={() => {
